...
export default function Navbar() {
  ...
  if (!mounted) {
    return (
      <nav className="fixed w-full z-50 backdrop-blur-md border-b transition-colors duration-300 bg-[var(--background)]/80 border-[var(--card-border)]">
              ...
              <button
                ...
                className={`p-2 rounded-full transition-colors ${
                  isDark
                    ...
                    : "bg-[var(--card-bg)] text-text-muted hover:text-foreground hover:bg-[var(--background)]"
                }`}
                aria-label="Toggle theme"
              >
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors ${
                isDark
                  ...
                  : "bg-slate-100 text-text-muted hover:text-foreground"
              }`}
              aria-label="Toggle theme"
            >
              {isDark ? <Moon size={20} /> : <Sun size={20} />}
      ...
      {isOpen && (
        <div
          className={`md:hidden border-b ${
            isDark ? "bg-slate-900 border-slate-800" : "bg-[var(--background)] border-[var(--card-border)]"
          }`}
        >
